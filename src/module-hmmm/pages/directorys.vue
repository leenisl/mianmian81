...
<el-card>
      ...
      <el-table border :data="tableData" style="width:1112px">
        ...
        <el-table-column label="操作" width="200">
          <template slot-scope="scope">
            ...
            <el-button type="text" size="small" @click="forbidden(scope.row)">{{scope.row.state ? "禁用" : '启动'}}</el-button>
  ...
  <!-- 分页 -->
    <el-row type='flex' justify="center">
      <el-pagination background  :total="page.total" :page-size="page.pagesize" :current-page="page.page" @current-change='fenye'></el-pagination>
    </el-row>
    </el-card>
</template>
