    ...
    <el-card class="box-card">
      <el-form ref="newQuestionsForm" :rules="formDataRules" :model="formData" label-width="80px">
        ...
        <el-form-item label="题干" prop="question">
          <quill-editor :options="editorOption"  style="width:1200px;height:218px;margin-bottom:100px" v-model="formData.question"></quill-editor>
        </el-form-item>
        ...
        <el-form-item label="答案解析" prop="answer">
          <quill-editor :options="editorOption" style="width:1200px;height:218px;margin-bottom:100px" v-model="formData.answer"></quill-editor>
        </el-form-item>
       ...
       <el-form-item class="button">
        <el-button  @click="submitQuestion" style="width:100px" type="primary">提交</el-button>
